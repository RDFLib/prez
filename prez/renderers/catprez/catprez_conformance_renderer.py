...
class CatPrezConformanceRenderer(Renderer):
    ...
    def _render_oai_html(
        ...
        _template_context = {
            ...
            "conformsTo": CatPrezConformanceRenderer.conformsTo,
    ...
    def _render_oai_json(self) -> JSONResponse:
        ...
        content = {
            "conformsTo": [
                conform["url"] for conform in CatPrezConformanceRenderer.conformsTo
            ]
        }
