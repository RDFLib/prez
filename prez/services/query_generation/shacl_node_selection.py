...
class NodeShape(Shape):
    ...
    targetClasses: Optional[List[URIRef]] = None
    propertyShapesURIs: Optional[List[URIRef]] = None
    propertyShapes: Optional[List[PropertyShape]] = None
    ...
    def from_graph(self):  # TODO this can be a SPARQL select against the system graph.
        ...
        self.propertyShapes = [PropertyShape(
            uri=ps_uri,
            graph=self.graph,
