...
This guide explains how to configure Prez when running behind a reverse proxy (such as Traefik, Nginx, Apache, or cloud load balancers).
...
<VirtualHost *:80>
    ...
    ProxyPass / http://prez:8000/
    ProxyPassReverse / http://prez:8000/
