...
from prez.dependencies import get_queryable_props
...
def test_ps_1():
    ...
    assert (
        ...
        == "?focus_node ^<http://example.com/hasFeatureOfInterest>/^<http://example.com/hasMember>*/<http://example.com/hasSimpleResult> ?path_node_1"
    )
...
def test_ps_2():
    ...
    assert (
        ps.tssp_list[0].to_string()
        == "?focus_node ^<http://www.w3.org/ns/sosa/hasFeatureOfInterest>/<http://www.w3.org/ns/sosa/hasMember>/<http://www.w3.org/ns/sosa/hasResult>/<http://rs.tdwg.org/dwc/terms/scientificNameID> ?path_node_1"
    )
